...
def run(test, params, env):
    ...
    if create_partition_cmd:
        ...
        logging.info("Output of command of create partition on disk: %s" % output)
    ...
    if format_cmd:
        ...
        logging.info("Output of format disk command: %s" % output)

    mount_cmd = params.get("mount_cmd")
    show_dev_cmd = params.get("show_dev_cmd")
    if mount_cmd:
        ...
        logging.info("Output of mount disk command: %s" % output)
    ...
    if umount_cmd:
        ...
        logging.info("Output of umount disk command: %s" % output)
